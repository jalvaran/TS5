                        ...
                        <td>
                            ...
                            <?php 
								...
								while($row=mysql_fetch_array($pa)){
									...
									$css->ColTablaFormInputText("FrmEdit$row[idPrecotizacion]",$myPage,"post","_self","TxtEditar","Number",$row['Cantidad'],"","","","","","150","30","","","TxtPrecotizacion",$row['idPrecotizacion'],$idPreventa);
